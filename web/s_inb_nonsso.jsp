...
<%response.setHeader("Pragma", "no-cache");
    ...
    response.setHeader("Content-Disposition", "filename=\"s-bb.jnlp\";");
...
<jnlp spec="1.0+" codebase="<%=codebase%>" href="">
    ...
    <applet-desc
        ...
        <param name="serverURL" value="/forms/lservlet?ifcfs=/forms/frmservlet?config=qadb&#38;ifsessid=WLS_FORMS.formsapp.1625&#38;acceptLanguage=en-US,en;q=0.8,en-CA;q=0.6"/>
        <param name="serverArgs" value="escapeParams=true module=guainit.fmx userid=  debug=no host= port= obr=no record= tracegroup= log= term= ssoProxyConnect=no"/>
